...
@interface PickDateView ()<UIPickerViewDelegate,UIPickerViewDataSource>
...
@end
static NSInteger kToobarHeight = 40;
...
-(void)setFrameWith:(BOOL)isHaveNavControler{
    CGFloat toolViewX = 0;
    CGFloat toolViewH = _pickeviewHeight+kToobarHeight;
    CGFloat toolViewY ;
...
-(void)setUpPickView{
    ...
    pickView.frame=CGRectMake(0, kToobarHeight, KScreenWidth, pickView.frame.size.height);
...
-(void)setUpDatePickerWithdatePickerMode:(UIDatePickerMode)datePickerMode{
    ...
    datePicker.frame=CGRectMake(0, kToobarHeight, KScreenWidth, datePicker.frame.size.height);
...
-(void)setToolbarWithPickViewFrame{
    _toolbar.frame=CGRectMake(0, 0,[UIScreen mainScreen].bounds.size.width, kToobarHeight);
}
