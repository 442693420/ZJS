...
@interface QuotePriceStyleFiveView : UIView
@property (nonatomic , strong)UILabel *timeLab;
@property (nonatomic , strong)UILabel *nameLab;

@property (nonatomic , strong)UIView *priceBgView;//下方显示价格和涨跌的View，此处可能隐藏此View，显示点击查看报价的button
@property (nonatomic , strong)UILabel *spotPriceLab;//现货价格
@property (nonatomic , strong)UILabel *orderPriceLab;//订货价格
